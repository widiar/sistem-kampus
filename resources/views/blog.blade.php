            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry">
                        ...
                        <div class="entry-img">
                            <img src="{{ asset('landing-page/img/blog/blog-1.jpg') }}" alt="" class="img-fluid">
                        </div>
                    ...
                    <article class="entry">
                        ...
                        <div class="entry-img">
                            <img src="{{ asset('landing-page/img/blog/blog-2.jpg') }}" alt="" class="img-fluid">
                        </div>
                    ...
                    <article class="entry">
                        ...
                        <div class="entry-img">
                            <img src="{{ asset('landing-page/img/blog/blog-3.jpg') }}" alt="" class="img-fluid">
                        </div>
                    ...
                    <article class="entry">
                        ...
                        <div class="entry-img">
                            <img src="{{ asset('landing-page/img/blog/blog-4.jpg') }}" alt="" class="img-fluid">
                        </div>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-item recent-posts">
                            <div class="post-item clearfix">
                                <img src="{{ asset('landing-page/img/blog/blog-recent-1.jpg') }}" alt="">
                                <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>
                                <time datetime="2020-01-01">Jan 1, 2020</time>
                            </div>

                            <div class="post-item clearfix">
                                <img src="{{ asset('landing-page/img/blog/blog-recent-2.jpg') }}" alt="">
                                <h4><a href="#">Quidem autem et impedit</a></h4>
                                <time datetime="2020-01-01">Jan 1, 2020</time>
                            </div>

                            <div class="post-item clearfix">
                                <img src="{{ asset('landing-page/img/blog/blog-recent-3.jpg') }}" alt="">
