...
@section('title', 'Portofolio Details')
                    ...
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="{{ asset('landing-page/img/portfolio/portfolio-1.jpg') }}" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="{{ asset('landing-page/img/portfolio/portfolio-2.jpg') }}" alt="">
                            </div>

                            <div class="swiper-slide">
                                <img src="{{ asset('landing-page/img/portfolio/portfolio-3.jpg') }}" alt="">
                            </div>
