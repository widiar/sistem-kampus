...
<h1 class="h3 mb-0 text-gray-800">Questions Category<span class="badge" style="cursor: pointer" data-toggle="modal"
        data-target="#exampleModal"><i class="fas fa-question-circle"></i></span></h1>
@endsection

@section('content')
<a href="{{ route('admin.questions.category.create') }}">
            ...
            <tbody class="actionz">
                ...
                <tr>
                    ...
                    <td class="row justify-content-center" style="min-width: 120px">
                        <a href="{{ route('admin.questions.category.edit', $data->id) }}" class="mx-2">
                            <button class="btn btn-primary"><i class="fas fa-edit"></i></button>
                        </a>
                        <form action="{{ route('admin.questions.category.delete', $data->id) }}" method="POST"
                            class="deleteData" data-extra="{{ $data->name }}">
                            @method('DELETE')
                            @csrf
